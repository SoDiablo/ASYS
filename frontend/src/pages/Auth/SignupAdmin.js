          ...
          <div className="bg-surface-container-lowest p-10 border border-outline-variant/10">
            <div className="mb-8">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="text-2xl font-black tracking-tighter text-primary">Admin Registration</h2>
              </div>
              <p className="text-sm text-on-surface-variant">
                Create your building manager account to manage site logistics, parking, and residents.
              </p>
            </div>
