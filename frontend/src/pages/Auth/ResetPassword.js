        ...
        <section className="w-full max-w-md">
          <div className="bg-surface-container-lowest p-8 shadow-sm border border-outline-variant/10">
            <div className="mb-10 text-center">
              <span className="material-symbols-outlined text-5xl text-primary mb-4 block">key</span>
              <h2 className="text-xl font-bold tracking-tight text-primary mb-2">Create New Password</h2>
            ...
            {success ? (
              <div className="space-y-6">
                ...
                <Link
                  to="/login"
                  className="w-full block text-center bg-primary text-on-primary py-4 text-sm font-bold tracking-tight hover:bg-primary-container transition-all duration-300"
                >
                  Go to Login
                </Link>
              </div>
